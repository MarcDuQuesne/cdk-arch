...
export class ExcaliDrawPrimitive{

    props: Required<ExcaliDrawPrimitiveProps>
...
export interface LineProps extends ExcaliDrawPrimitiveProps {
    fillStyle?: FillStyle;
    strokeWidth?: number;
...
export interface RectangleProps extends ExcaliDrawPrimitiveProps {
    strokeColor?: string;
    backgroundColor?: string;
    fillStyle?: FillStyle;
    strokeStyle?: StrokeStyle;
...
export interface TextProps extends ExcaliDrawPrimitiveProps {
    fillStyle?: FillStyle,
    strokeWidth?: number,
    strokeStyle?: StrokeStyle,
    roughness?: number,
...
export class Rectangle extends ExcaliDrawPrimitive {

    props: Required<RectangleProps>;
